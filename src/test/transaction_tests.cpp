...
BOOST_AUTO_TEST_CASE(test_IsStandard) {
    ...
    // MAX_OP_RETURN_RELAY-byte (223 byte) TX_NULL_DATA (standard)
    t.vout[0].scriptPubKey =
        CScript() << OP_RETURN
                  << ParseHex("436c61736869632077617320636f6f6c2092c558ed52c56d"
    ...
    // MAX_OP_RETURN_RELAY+1-byte (>223 byte) TX_NULL_DATA (non-standard)
    t.vout[0].scriptPubKey =
        CScript() << OP_RETURN
                  << ParseHex("436c61736869632077617320636f6f6c2092c558ed52c56d"
                              "8dd14ca76226bc936a84820d898443873eb03d8854b21fa3"
