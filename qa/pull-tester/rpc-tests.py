...
# Set env vars
if "TITLED" not in os.environ:
    os.environ["TITLED"] = BUILDDIR + '/src/titled' + EXEEXT
...
if not (ENABLE_WALLET == 1 and ENABLE_UTILS == 1 and ENABLE_TITLED == 1):
    print(
        "No rpc tests to run. Wallet, utils, and titled must all be enabled")
    sys.exit(0)
...
class RPCTestHandler:
    ...
    def __init__(self, num_tests_parallel, test_list=None, flags=None):
        ...
        self.flags = flags
        self.num_running = 0
        # In case there is a graveyard of zombie titleds, we can apply a
...
class RPCCoverage(object):
    ...
    commands per `title-cli help` (`rpc_interface.txt`).
