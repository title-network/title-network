...
unlocked to sign the TitleNetwork-Qt.app bundle.
...
allowing somebody to distribute a TitleNetwork-Qt.app or title-qt-setup.exe with a valid
...
that the title-qt.exe file inside the installer had not been tampered with.
